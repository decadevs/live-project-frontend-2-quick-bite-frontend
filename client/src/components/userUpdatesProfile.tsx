...
const initialUserData = {
 ...
 const UserUpdatesProfile = () => {
    ...
    const dispatch = useAppDispatch()
     ...
     useEffect(()=>{
        setUser({...user, firstName:logedInUser?.firstname as string, lastName:logedInUser?.lastname as string, email:logedInUser?.email as string, address:logedInUser?.address as string, phoneNumber:logedInUser?.phone_no as string})
     }, [logedInUser, user])
